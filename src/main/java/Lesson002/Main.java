...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        gt.put(new Human("Петр", "male"));
        pr.printHuman(gt.get(1));
        gt.put(new Human("Екатерина", "female"));
        ...
        gt.put(new Human("Александр", "male"));
